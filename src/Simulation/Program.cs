...
internal class Program
{
    ...
    private static void RunTrainVolModel() {
        Console.WriteLine("Training volatility machine learning model...");
        var volModel = new VolMlModel();
        var networkFile = @"c:\temp\spxVolModel.nn";
        volModel.Load(@"c:\temp\spx.csv", networkFile, forTraining: true);
    ...
    private static void RunTestVolModel() {
        var volModelApr = new VolMlModel();
        var volModelLatest = new VolMlModel();
        volModelApr.Load(@"c:\temp\spx_Apr.csv", @"c:\temp\spxVolModel.nn", forTraining: false);
        volModelLatest.Load(@"c:\temp\spx.csv", @"c:\temp\spxVolModel.nn", forTraining: false);
